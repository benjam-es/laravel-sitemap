...
.url:hover
{
  ...
  <body>
	<div id="content">
		...
		<p class="expl">Generated by <a href="https://github.com/r94ever/laravel-sitemap" target="_blank" title="Sitemap generator for Laravel">r94ever-sitemap</a>. This is styled xml sitemap (for Google News), sorted by update date.</p>
